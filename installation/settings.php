 ...
 *
 */
$drupal_hash_salt = 'c2e4Um2clIdTxvcLr7oOrKW3EOP0-gvgMBFi-B13W_s';
...
/* From here on some extra settings
 * EV, april 2014
 */
...
//FROM HERE ON SOME CUSTOM SETTINGS

//The definition here will be preferred over the constants set later, based on the fact that constants 
//can be defined only once and are not overwritten later on.
define('_DEBUG', FALSE);
define('_VALS_SOC_TEST_ENV', FALSE);
define('_INSTALL_BY_SCRIPT', TRUE);