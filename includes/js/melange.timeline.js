...
!function ($) {
  ...
  * ==================== */
  ...
  Timeline.prototype.setOptionsAndDraw = function (options) {
    ...
    var first_non_off_season_slice = this.options.slices[1];
    //var last_slice = this.options.slices[this.options.slices.length -1];
    //original: var year_to_print = new Date(last_slice.to).getFullYear();
    var year_to_print = new Date(first_non_off_season_slice.from).getFullYear();
    console.log(' ff checken ',first_non_off_season_slice ,this.options.slices[ 1], this.options.slices[2]);
  ...
  */
  ...
  Timeline.prototype.draw = function (R, slices, year_to_print, options,
    ...
    // Add top lines
    if (!slice_active){
        options.title_element.html('Timeline');
    }
...
//    R.path('M0 1.5L187 1.5').attr({stroke: options.color_blue_light});
  ...
  Timeline.prototype.draw_slice = function (R, slice, options, slice_active) {
    ...
    slice._piece = R.path()
      ...
      .mouseover(function () {
        ...
        if (slice_active && (slice !== slice_active)) {
  ...
  Timeline.prototype.draw_wires = function (R, x, y, r, a1, a2,
    color_w1, color_w2) {
    var wires = R.set();
